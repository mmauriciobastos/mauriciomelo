...
class GKTemplateLayout {
	...
	public function generateLayoutWidths() {
		...
		$this->API->addCSSRule('#gkBottom1 .box.normal-width, #gkBottom2 .box.normal-width, #gkBottom3 .box.normal-width, #gkBottom4 .box.normal-width { max-width: '.$template_width.'px; }' . "\n");
