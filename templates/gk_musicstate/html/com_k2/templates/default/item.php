...
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?>"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
          <header<?php if(!$this->item->params->get('itemDateCreated')): ?> class="nodate"<?php endif; ?>>
                    ...
                    <ul>
                              ...
                              <li class="date-hidden"><time datetime="<?php echo JHtml::_('date', $this->item->created, DATE_W3C); ?>"><?php echo JHTML::_('date', $this->item->created, JText::_('F j Y')); ?></time></li>
                              <?php endif; ?>
                    </ul>
                    <?php endif; ?>
                    <?php if($this->item->params->get('itemDateCreated')): ?>
                    <time datetime="<?php echo JHtml::_('date', $this->item->created, DATE_W3C); ?>"><?php echo JHTML::_('date', $this->item->created, JText::_('j')); ?><span><?php echo JHTML::_('date', $this->item->created, JText::_('M')); ?></span></time>
                    <?php endif; ?>
          </header>
          
          <?php if($params->get('itemImage') && !empty($this->item->image)): ?>
          <div class="itemImageBlock"> <a data-k2-modal="image" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>"> <img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" /> </a>
