	...
	<div class="ptl pbl">
		...
		<div class="author-info">
			...
			<?php if ( $blogger->getBioGraphy() != '' ){ ?>
				<div class="author-about"><?php echo $blogger->getBioGraphy(); ?>
				<?php if( $blogger->getWebsite() != '' ){ ?>
					<a href="<?php echo $this->escape( $blogger->getWebsite() ); ?>" target="_blank" class="author-url" rel="nofollow"><?php echo $this->escape( $blogger->getWebsite() ); ?></a>
				<?php } ?></div>
			<?php } ?>
